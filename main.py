...
# print("\n**************PERFORMING SUBTYPE SORT**************\n")
# searchSubType(sortedArray, {"human", "soldier"})
# printSubType(sortedArray)

# # print("\n**************PERFORMING CMC SORT**************\n")
# # searchCMC(sortedArray, 2, 5, "merge")
# # printCMC(sortedArray)

# # print("\n**************PERFORMING POWER SORT**************\n")
# # searchPower(sortedArray, 1, 3, "quick")
# # printPower(sortedArray)

# print("\n**************PERFORMING TOUGH SORT**************\n")
# searchTough(sortedArray, 3, 4, "quick")
# printTough(sortedArray)

# print("\n**************PERFORMING COLOR SORT**************\n")
# searchColor(sortedArray, "W")
# printColor(sortedArray)
